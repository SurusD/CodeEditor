...
public class Editor extends EditText {
	public static class LanguagesSyntaxHighlightPatterns {
		public static HashMap<String, PatternGroup> languages_in_lower_case = new HashMap<>();

		public static PatternGroup getPatternsForLanguage(String language) {
			if (languages_in_lower_case.size() <= 0) {
				languages_in_lower_case.put("javascript", PatternGroup.parse(new ColoredPattern("#F08000",
				...
				languages_in_lower_case.put("java_script", languages_in_lower_case.get("javascript"));
				languages_in_lower_case.put("java script", languages_in_lower_case.get("javascript"));
			}
			return languages_in_lower_case.get(language.toLowerCase());
		}
		
		public void putLanguage(String language_in_lower_case,PatternGroup pg){
			languages_in_lower_case.put(language_in_lower_case,pg);
		}
